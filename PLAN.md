...
| Common code review | 77 complete texts / 122,682 tokens reviewed; 43 of 218 records family-held; 100 unheld records unread | [TypeScript/C#/Kotlin review](experiments/corpus-audit/typed-language-cohort-review.json); file roles recorded alongside original labels/weights; holds preserved; no yield estimate or admission |
...
2. **Complete the fixed code-cohort assessment, then compare other banks.** The original
   ...
   sampling frames remain distinct. The [TypeScript/C#/Kotlin follow-up](experiments/corpus-audit/typed-language-cohort-review.json)
   extends common full-text coverage to 77 records, preserving all 43 holds. Declarations, generated
   code, tests and teaching scaffolds need distinct context; original labels and weights remain intact.
   Installed Arcade/stringutils identities are verified; stringutils also matches its published wheel.
   Continue the 100 currently unheld records outside full-read coverage. Complete broader lineage
