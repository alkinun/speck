...
| Common code review | 36 complete texts / 38,827 tokens reviewed; all 16 initially unheld Python files read; 42 of 218 records now family-held | [Python validation](experiments/corpus-audit/python-cohort-validation.json), [family/provenance follow-up](experiments/corpus-audit/code-family-provenance.json); GoLLIE and vendored Pylint holds propagated; no yield estimate or admission |
...
2. **Complete the fixed code-cohort assessment, then compare other banks.** The original
   ...
   sampling frames remain distinct. The [Python follow-up](experiments/corpus-audit/python-cohort-validation.json)
   extends common full-text coverage to 36 records. The [family assessment](experiments/corpus-audit/code-family-provenance.json)
   ...
   Continue the 142 currently unheld records outside full-read coverage. Complete broader lineage
