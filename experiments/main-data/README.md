...
The external Cagliostro v3 review also identifies OpenMathInstruct-2, FineMath's InfiWebMath 3+ subset and SmolTalk as metadata-only candidates not yet registered in this matrix. They remain outside retained inventory and every study arm until their source-use, family/contamination, correctness, finite-supply and runtime evidence is added to a future matrix revision. A late math reweighting is a schedule hypothesis, not an additional arm.
