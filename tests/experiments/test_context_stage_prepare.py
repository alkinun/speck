...
from speck.experiments.context import promote_global_attention_layers, stage_configs
from speck.model.architecture import ArchitectureConfig, AttentionSpec
from tests.reference import historical_repository

experiment = historical_repository() / "experiments" / "Speck1-140M"
local_experiment = (
    historical_repository() / "experiments" / "SpeckLC-150M-MixerScreen-131M" / "gdn-local"
)
