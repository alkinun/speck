...
from speck.data.sources.science_sample import (
    _SPACED_OCR,
    _compressed_rows,
    _field,
...
from speck.data.sources.text_contamination import validate_text_contamination_config
from speck.data.sources.text_near_duplicates import validate_text_duplicate_config
