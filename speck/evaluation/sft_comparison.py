...
from speck.evaluation.instruct import QUESTIONS, score
from speck.model import SpeckForCausalLM
from speck.model.architecture import ArchitectureConfig
from speck.model.generation import generate_tokens
...
def main(argv=None):
    ...
    report = {
        ...
        "scorer_sha256": file_sha256(Path(__file__).with_name("instruct.py")),
