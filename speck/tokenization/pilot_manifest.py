...
from speck.model.accounting import flop_accounting, model_settings, parameter_accounting
...
from speck.provenance.validation import positive_integer, require_keys
...
def validate_run_materialization_plan(value, *, config_dir=None):
    ...
    repository_root = find_repository_root(pilot_identity["path"])
...
def build_screen_run_manifests(plan, *, repository_revision=None):
    ...
    repository = find_repository_root(plan["pilot_plan"]["path"])
