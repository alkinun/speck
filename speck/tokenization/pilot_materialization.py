...
from speck.model.accounting import flop_accounting
...
from speck.tokenization.pilot_manifest import (
    _by_id,
    _clean_git_revision,
    _fingerprint,
    _identity,
...
def _legacy_plan(value, config_dir):
    ...
    repository = find_repository_root(pilot_path)
...
def validate_corrected_materialization_plan(value, *, config_dir=None):
    ...
    repository = find_repository_root(normalized_legacy["pilot_plan"]["path"])
