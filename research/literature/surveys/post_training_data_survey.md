...
[POST_TRAINING.md](../../flagship/POST_TRAINING.md). It does not approve a corpus, prescribe final
...
digest: [post_training_dataset_survey_v0.json](../../../archive/pregrant-history/research/flagship/post_training_dataset_survey_v0.json). These are source
...
The current [training plan](../../flagship/POST_TRAINING.md) uses guided curation and milestone evaluation. The
