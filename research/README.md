...
complete 4K through 32K matrices are also qualified across two byte-identical, network-denied generations
per length. A pinned compatibility patch repairs an upstream HotpotQA non-termination without changing
prompt or scoring semantics. The 64K and 128K RULER matrices are not generated yet. NoLiMa requires
acceptance of a
