...
| R10 | Decide tokenizer D5 | Formal static phase and conservative firewall-superset corpus exclusion pass; 2.056B retained Mistral-reference tokens exceed the 1.2B requirement; fixed stream, seven matched runs, and unopened D5 audit remain | Materialize the fixed document stream and seven-run pilot, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
