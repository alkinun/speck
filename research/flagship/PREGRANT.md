...
| R4 | Build the evaluation firewall | Twelve real source-balanced views and 1.35 GB text pass global exact/verified-near deduplication (288,876 seen, four near removals); final construction config is frozen and partition materialization is pending | Tokenizer sample, equal-byte selection set, unseen-source slices, and sealed audits are immutable and decontaminated before outputs | SPE-114 |
