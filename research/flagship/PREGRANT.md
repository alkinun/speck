...
| R10 | Decide tokenizer D5 | Deterministic tooling complete; bounded code technically passes but is rights-blocked; bounded web passes sampling/security/overlap but awaits firewall contamination and rights; four categories and all runs pending; Mistral 32K fallback | Freeze source-balanced sample, three custom candidates, static report, matched 60M pilot, one-opening audit, selected artifact/hash, and repacking branch before E1/C0 | SPE-117 |
