...
| R10 | Decide tokenizer D5 | Formal static phase passes; the fixed 60M geometry and a conservative pilot-corpus preprocess against all twelve firewall candidate views are hash-frozen; corpus pass, seven matched runs, and unopened D5 audit remain | Complete the excluded fixed document stream and seven-run pilot, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
