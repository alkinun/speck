...
| R2 | Add and qualify a code source | 38-source registry complete; Stack v3.1 adapter, pinned Gitleaks, engineering-license, English-prose, and tokenizer-partition gates pass; training blocked on legal acceptance, cross-source dedup, contamination, and cleanup/resume | Restricted Stack v3.1, Stack-Edu, and blend treatments pass rights, provenance, English-text, repository-split, dedup, contamination, secret/PII, yield, and operational gates | SPE-114 |
