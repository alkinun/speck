...
| R3 | Calibrate production data operations | Full 20B attempt safely paused; 2B calibration acquisition completed across six categories, while the resumable global-dedup stage stopped after 505,534 records and packing/resume/firewall stages remain open | The resumed 2B path completes exact/near dedup, packing, cleanup, interruption equivalence, and disjointness; measured 20B and 150B/500B projections receive an explicit fallback decision or the full rehearsal resumes | SPE-174, SPE-173 |
