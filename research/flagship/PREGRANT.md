...
| R3 | Run the 20B data rehearsal | Six-stage orchestration fixture-qualified and human source use approved; exact production manifest and real run pending | Download, filtering, exact/near dedup memory, packing throughput, storage, cleanup, and resume are measured | SPE-114 |
