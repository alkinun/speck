...
| R11 | Materialize scale targets | Complete as non-launchable v1 geometry: seven targets pass independent and instantiated parameter/FLOP/state/optimizer accounting; D5 and untied-head freeze remain explicit | 60M–1.2B configs pass exact parameter/FLOP/state accounting | SPE-60 |
