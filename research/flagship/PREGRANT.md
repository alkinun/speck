...
| R3 | Run the 20B data rehearsal | Exact six-category production plan and six-stage orchestration frozen after human source approval; real run not yet complete | Download, filtering, exact/near dedup memory, packing throughput, storage, cleanup, and resume are measured | SPE-114 |
