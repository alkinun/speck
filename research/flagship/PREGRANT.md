...
| R10 | Decide tokenizer D5 | Local bounded study nominates exact-32K BPE with whitespace-only pieces after a same-cost 7.23% static compression gain; formal inputs/runs and D5 audit remain blocked/pending | Freeze a versioned source-balanced sample and corrected candidates, static report, matched 60M pilot, one-opening audit, selected artifact/hash, and repacking branch before E1/C0 | SPE-117 |
