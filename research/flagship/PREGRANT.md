...
| R10 | Decide tokenizer D5 | Formal static and all stream gates pass; preflight v1 correctly issued no authority but its first shape retained compile cost; a unique-shape device-batch-four successor is frozen; corrected preflight, materializer, seven runs, and unopened D5 remain | Pass corrected throughput preflight, materialize and execute seven runs, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
