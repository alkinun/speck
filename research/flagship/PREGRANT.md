...
| R3 | Run the 20B data rehearsal | Six-stage durable orchestration and production tooling fixture-qualified; real rights-bound manifest and run pending | Download, filtering, exact/near dedup memory, packing throughput, storage, cleanup, and resume are measured | SPE-114 |
...
| R10 | Decide tokenizer D5 | All 30 real inputs technically frozen but non-executable; Mistral and all three full-size custom paths fixture-qualified; rights/production, real sample, static comparison, pilot, and audit pending | Freeze source-balanced sample, three custom candidates, static report, matched 60M pilot, one-opening audit, selected artifact/hash, and repacking branch before E1/C0 | SPE-117 |
