...
| R10 | Decide tokenizer D5 | Formal static and corpus exclusion pass; one 1,106,243-document stream is packed under Mistral, 40,960, and exact-32K with the 1,200,007,273-token reference endpoint frozen; exact run materializer, seven runs, and unopened D5 audit remain | Materialize and run the seven-run pilot, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
