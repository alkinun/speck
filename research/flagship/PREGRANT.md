...
| R3 | Run the 20B data rehearsal | Disk-backed exact/near dedup, deny-ledger, cleanup, and resume tooling fixture-qualified; real manifest and run pending | Download, filtering, exact/near dedup memory, packing throughput, storage, cleanup, and resume are measured | SPE-114 |
...
| R5 | Prepare flagship corpora | All six bounded categories technically qualified; consolidated 30-source human decision and 20B rehearsal pending | Six-category stable candidates are launch-ready; decay candidates can finish before E4; unique-token risk is explicit | SPE-114 |
...
| R10 | Decide tokenizer D5 | Deterministic tooling complete; all six bounded categories technically pass but remain rights/production blocked; final partitions and all runs pending; Mistral 32K fallback | Freeze source-balanced sample, three custom candidates, static report, matched 60M pilot, one-opening audit, selected artifact/hash, and repacking branch before E1/C0 | SPE-117 |
