...
| R10 | Decide tokenizer D5 | Formal static and all stream/capacity gates pass; exact 65,536-token optimizer boundaries and a three-shape CUDA throughput preflight are frozen; preflight, run materializer, seven runs, and unopened D5 remain | Pass throughput preflight, materialize and execute seven runs, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
