...
| R10 | Decide tokenizer D5 | Formal static and stream gates pass; corrected batch-four preflight projects 3.19 screen hours and 7.48 worst-case seven-run hours (29.94 h at 4×); three-run screen is authorized, but exact run/evaluation materialization remains | Materialize and run the screen, reproject confirmation from observed overhead, complete eligible runs, open D5 once, then freeze artifact/hash | SPE-117 |
