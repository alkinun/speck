...
| R10 | Decide tokenizer D5 | Formal static, corpus exclusion, fixed stream, and corrected 72.025M-reference-token continuation pass; all three packs clear exact fixed-document/equal-FLOP capacity; run materializer, seven runs, and unopened D5 remain | Materialize and execute the seven-run pilot, open the audit once, then freeze artifact/hash and repacking branch before E1/C0 | SPE-117 |
