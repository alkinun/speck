...
| R10 | Decide tokenizer D5 | Three hash-bound seed-42 records are authorized; the Mistral arm reached checkpoint 3,662 before a mechanical interruption, its uncommitted step-3,664 evaluation is preserved outside scientific lineage, and identical-manifest resume is authorized | Resume Mistral, complete the three-arm screen, reproject confirmation from observed overhead, complete eligible confirmation runs, open D5 once, then freeze artifact/hash | SPE-117 |
