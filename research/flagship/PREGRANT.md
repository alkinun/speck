...
| R10 | Decide tokenizer D5 | Real inputs blocked; Mistral/custom training, static nomination, and seven-run pilot analysis fixture-qualified; real sample/runs and D5 audit pending | Freeze source-balanced sample, three custom candidates, static report, matched 60M pilot, one-opening audit, selected artifact/hash, and repacking branch before E1/C0 | SPE-117 |
