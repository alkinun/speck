...
- [`tokenizer_pilot_plan_v6.json`](tokenizer_pilot_plan_v6.json) binds the fixed stream and corrected
  availability-aware equal-FLOP continuation; exact seven-run materialization remains blocked.
