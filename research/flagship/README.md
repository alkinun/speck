...
- [`tokenizer_pilot_plan_v5.json`](tokenizer_pilot_plan_v5.json) binds the fixed document stream and
  pre-results equal-FLOP continuation; exact seven-run materialization remains blocked.
