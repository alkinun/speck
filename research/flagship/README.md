...
- [`tokenizer_pilot_plan_v4.json`](tokenizer_pilot_plan_v4.json) binds the passed corpus exclusion and
  fixed three-tokenizer document stream; exact seven-run materialization remains blocked.
