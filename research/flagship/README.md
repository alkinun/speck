...
- [`tokenizer_pilot_plan_v8.json`](tokenizer_pilot_plan_v8.json) binds passed streams plus exact
  optimizer-aligned stops and the pending CUDA throughput preflight.
