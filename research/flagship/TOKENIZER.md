...
Status: tooling complete, source inputs pending, 2026-09-07. The first flagship should use a
Speck-trained tokenizer only if it clears this protocol. Mistral 32K remains the frozen fallback until
the final source-balanced sample and matched language-model pilot are complete.
